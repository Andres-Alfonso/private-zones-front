// app/routes/activities/games/complete-phrase/create.tsx
...
export const action: ActionFunction = async ({ request, params }) => {
    ...
    try {
        ...
        const response = await CompletePhraseAPI.create(activityId, completePhraseData, apiClient);
...
export default function CreateCompletePhraseGame() {
            ...
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 p-6 mb-6">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Configurar Completar Frases</h1>
                            <p className="text-gray-600">Define las frases y espacios en blanco del juego</p>
                        </div>
                    </div>
                </div>
