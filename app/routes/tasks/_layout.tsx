...
import { json, MetaFunction, NavLink, Outlet, useLoaderData, useLocation, useParams } from '@remix-run/react';
import { ArrowLeft, BookOpen, Grid, Plus } from 'lucide-react';
...
export const meta: MetaFunction = () => {
    return [
        { title: "Gestión de tareas - Admin Panel" },
...
function TasksLayoutContent (){
    ...
    const isDetailPage = location.pathname.match(/\/tasks\/[^\/]+$/) && !isCreatePage;
    const isIndexPage = location.pathname === "/tasks";
    const isCourseTasksPage = location.pathname.includes("/tasks/courses/");
    ...
    return(
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            ...
            <div className="bg-white/80 backdrop-blur-sm shadow-lg border-b border-gray-200/50">
                <div className="container mx-auto px-4">
                    ...
                    <div className="py-6 border-b border-gray-200/50">
                        <div className="flex items-center justify-between">
                            ...
                            {/* Botón de volver si estamos en Tareas de un curso */}
                            {course && (
                                <div className="ml-4">
                                    <NavLink
                    ...
                    {!course && !isCreatePage && !isEditPage && !isDetailPage && (
                        <div className="py-6">
                            <div className="flex items-center justify-between">
                                ...
                                <RoleGuard
                                    requiredRoles={["superadmin", "admin", "instructor"]}
                                    requireAll={false}
                                >
                ...
                {/* Navigation Menu para Tareas de curso */}
                {course && isCourseTasksPage && (
                    <div className="">
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="flex items-center justify-between text-sm">
                        <div className="font-medium text-gray-700">
                            © {new Date().getFullYear()} Plataforma de Tareas
                        </div>
